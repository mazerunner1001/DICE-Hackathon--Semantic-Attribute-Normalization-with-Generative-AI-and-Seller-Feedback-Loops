...
function PriceTag() {
  return (
    <div className="sale-tag-overlay">
      <div className="sale-tag">SALE<br/><span>UPTO 80% OFF</span></div>
    </div>
  );
}
...
function CategoryCarousel() {
  ...
  const tiles = [
    ...
    { title: "Personal Care", brand: "mamaearth", img: "https://images.unsplash.com/photo-1515378791036-0648a3ef77b2?auto=format&fit=crop&w=400&q=80" },
    { title: "Health & Wellness", brand: "Patanjali", img: "https://images.unsplash.com/photo-1506784365847-bbad939e9335?auto=format&fit=crop&w=400&q=80" },
    { title: "Women Innerwear", brand: "Lyra", img: "https://images.unsplash.com/photo-1517841905240-472988babdf9?auto=format&fit=crop&w=400&q=80" },
      ...
      {tiles.map((t,i)=>(
        <div className="carousel-card" key={i}>
          <div className="carousel-art">
            <img alt={t.title} src={t.img} className="carousel-img" />
            <PriceTag />
